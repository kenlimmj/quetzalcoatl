...
namespace facerec
{
    ...
    public static class BitmapExtensions
    {
        ...
        /// <see cref="http://tech.pro/tutorial/660/csharp-tutorial-convert-a-color-image-to-grayscale"/>
        /// </summary>
        public static Bitmap MakeGrayscale(this Bitmap original, int newWidth, int newHeight)
        {
            // Create a blank bitmap at the desired size
        ...
        public static void HistogramEqualize(this Bitmap bitmap)
        {
            ...
            // Get the LUT for histogram equalization
            var histLut = HistogramEqualizationLut(rawData);

            for (int i = 0; i < rawData.Length; i += 4)
            {
                // Update pixels according to the LUT
        ...
        /// <summary>
        /// Gets the histogram equalization lookup table for separate R, G and B channels
        /// </summary>
        private static int[,] HistogramEqualizationLut(byte[] rawData)
        {
            // Get an image histogram - calculate values using the R, G and B channels
        ...
        /// <summary>
        /// Returns an array containing histogram values for separate R, G and B channels
        /// </summary>
