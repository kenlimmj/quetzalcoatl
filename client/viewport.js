var nav = {
    ...
    init: function() {
        ...
        if (!document.getElementById(navOverlayName)) {
          ...
          var navElement = document.querySelector("#" + navOverlayName);
        }

        // Draw a canvas in the nav overlay
        nav.overlay = new Kinetic.Stage({
            container: 'nav',
            width: document.getElementById(navOverlayName).offsetWidth,
            height: document.getElementById(navOverlayName).offsetHeight
        });
